...
authentication               4.22.x    True        False         False      3h
cloud-credential             4.22.x    True        False         False      4h
console                      4.22.x    True        False         False      3h
dns                          4.22.x    True        False         False      4h
etcd                         4.22.x    True        False         False      4h
ingress                      4.22.x    True        False         False      3h
kube-apiserver               4.22.x    True        False         False      4h
kube-controller-manager      4.22.x    True        False         False      4h
kube-scheduler               4.22.x    True        False         False      4h
machine-api                  4.22.x    True        False         False      4h
machine-config               4.22.x    True        False         False      4h
monitoring                   4.22.x    True        False         False      3h
network                      4.22.x    True        False         False      4h
openshift-apiserver          4.22.x    True        False         False      3h
storage                      4.22.x    True        False         False      4h
----
...
image::installation-images/clusteroperators-console-2.png[ClusterOperators in web console, link=self, window=blank]
...
version   4.22.x    True        False         3h      Cluster version is 4.22.x
----
...
* **stable-4.22** - Production-ready releases (recommended)
* **fast-4.22** - Early access to stable releases
* **eus-4.22** - Extended Update Support (14-month lifecycle)
* **candidate-4.22** - Pre-release testing
