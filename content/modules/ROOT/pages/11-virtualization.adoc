...
----
kubevirt-hyperconverged-operator.v4.22.x   OpenShift Virtualization   4.22.x   Succeeded
----
...
* **virtctl Reference:** link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/virtualization/virt-using-the-cli-tools#virt-virtctl-commands_virt-using-the-cli-tools[virtctl commands, window=blank]
...
* **VM Snapshots:** link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/virtualization/backup-restore[Backup and restore documentation, window=blank]
